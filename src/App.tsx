    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans antialiased selection:bg-emerald-500 selection:text-slate-950">
      ...
      <header className="max-w-4xl mx-auto px-6 pt-24 pb-12">
        ...
        <div className="mt-8 flex flex-wrap gap-4">
          <a 
            href={`mailto:${email}`}
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-semibold transition-all duration-200 text-sm shadow-lg shadow-emerald-500/10"
          >
            <FileText size={18} />
            Resume / Contact
          </a>
          <a 
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-slate-900 hover:bg-slate-800 text-slate-200 font-medium transition-all duration-200 border border-slate-800 text-sm"
          >
            <FaGithub size={18} />
            GitHub
          </a>
      ...
      <section className="max-w-4xl mx-auto px-6 py-8 border-t border-slate-900">
        ...
        <div className="bg-slate-900/50 rounded-xl p-6 border border-slate-900 hover:border-slate-800/80 transition-all">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1 mb-4">
            <div>
              <h3 className="text-lg font-bold text-slate-200">Digital Technology Intern</h3>
              <p className="text-sm text-emerald-400 font-medium">Build & Release Engineering — Baker Hughes</p>
            </div>
            <span className="text-xs font-mono bg-slate-950 px-3 py-1 rounded-full text-slate-400 border border-slate-900 self-start sm:self-center">
              Jan 2026 – Present
            </span>
          </div>
      ...
      <section className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="space-y-8">
          ...
          {/* PROJECT 1: PROTEIN PIPELINE */}
          <div className="bg-slate-900/50 rounded-xl p-6 border border-emerald-500/10 shadow-xl shadow-emerald-950/5">
            <div className="flex justify-between items-start mb-3">
              <div>
                <span className="inline-block text-[10px] uppercase tracking-widest font-bold bg-emerald-500/10 text-emerald-400 px-2 py-0.5 rounded mb-2">
                  Primary Research Project
                </span>
                <h3 className="text-xl font-bold text-slate-100">Protein Drug Interaction Pipeline</h3>
              </div>
              <span className="text-xs font-mono text-emerald-400 bg-emerald-950/30 border border-emerald-900/30 px-2.5 py-0.5 rounded">
                Best Project
              </span>
            </div>
            ...
            <div className="mb-6 bg-slate-950 p-4 rounded-lg border border-slate-900">
              ...
              <div className="flex flex-col md:flex-row items-center justify-center gap-2 text-center text-xs font-mono">
                <div className="bg-slate-900 p-2 rounded border border-slate-850 w-full md:w-auto text-slate-400">Protein Structure</div>
                <ArrowRight size={14} className="text-slate-700 rotate-90 md:rotate-0" />
                <div className="bg-slate-900 p-2 rounded border border-slate-850 w-full md:w-auto text-emerald-400">Feature Extraction</div>
                <ArrowRight size={14} className="text-slate-700 rotate-90 md:rotate-0" />
                <div className="bg-slate-900 p-2 rounded border border-slate-850 w-full md:w-auto text-slate-400">Random Forest</div>
                <ArrowRight size={14} className="text-slate-700 rotate-90 md:rotate-0" />
                <div className="bg-slate-900 p-2 rounded border border-slate-850 w-full md:w-auto text-emerald-400">Grid Prediction</div>
                <ArrowRight size={14} className="text-slate-700 rotate-90 md:rotate-0" />
                <div className="bg-slate-900 p-2 rounded border border-slate-850 w-full md:w-auto text-slate-400">AutoDock</div>
                <ArrowRight size={14} className="text-slate-700 rotate-90 md:rotate-0" />
            ...
            <div className="flex flex-wrap gap-2">
              {['Docker', 'Python', 'Random Forest', 'AutoDock Vina', 'Scientific Computing'].map((tech: string) => (
                <span key={tech} className="text-xs bg-slate-950 px-2.5 py-1 rounded text-slate-400 border border-slate-900">{tech}</span>
              ))}
            </div>
          </div>
          ...
          {/* PROJECT 2: VOXCUE */}
          <div className="bg-slate-900/50 rounded-xl p-6 border border-slate-900 hover:border-slate-800/80 transition-all">
            <h3 className="text-xl font-bold text-slate-100 mb-2">Voxcue</h3>
            ...
            <div className="bg-slate-950 p-3.5 rounded-lg border border-slate-900 text-xs font-mono text-slate-400 mb-4 space-y-1">
          ...
          {/* PROJECT 3: ECU OPTIMIZATION */}
          <div className="bg-slate-900/50 rounded-xl p-6 border border-slate-900 hover:border-slate-800/80 transition-all">
            <h3 className="text-xl font-bold text-slate-100 mb-2">EV ECU Boot Optimization</h3>
            <p className="text-slate-400 text-sm md:text-base mb-4 leading-relaxed">
            ...
            <div className="grid grid-cols-2 gap-4 max-w-xs mb-4 bg-slate-950 p-3 rounded-lg border border-slate-900 text-center font-mono">
              <div>
                <span className="text-[10px] text-slate-500 block uppercase">Baseline Boot</span>
                <span className="text-lg font-bold text-rose-400">40s</span>
              </div>
              <div className="border-l border-slate-900">
                <span className="text-[10px] text-emerald-400 block uppercase">Optimized Boot</span>
      ...
      <section className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm text-slate-300">
          <div className="p-3.5 rounded-lg bg-slate-900/40 border border-slate-900 flex items-center gap-3">
      ...
      {/* FOOTER */}
      <footer className="max-w-4xl mx-auto px-6 pt-16 pb-12 text-center text-[11px] text-slate-600 font-mono border-t border-slate-900">
